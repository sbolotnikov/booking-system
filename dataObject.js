    ...
    games : [
        ...
        },  
        {
          ...
          maxParticipants:4
              ...
              // {link:'/images/arrowsign.jpg',title:'Указатели'}
      locations: [
        
        {
            ...
            images:[{link:'/images/room1.jpg',title:'picture1 Hall'},{link:'/images/room2.jpg',title:'front desk'},{link:'/images/room3.jpg',title:'waiting area'}]
        },
      ],
      questions : [
        {
        ...
        },
        {
          ...
          answer:'-10% скидка имениннику, действует 10 дней ДО и ПОСЛЕ события<br/>-20% скидка для команды из 2-х человек<br/>- максимальная скидка заложена в пакетных предложениях<br/>- скидку можно получить, участвуя в акциях и розыгрышах в группе <a href="https://vk.com/chexit"><button class="btnBlue1">ВК</button></a><br/>Акции и скидки не суммируются.'
        },
        {
          question:'Можно приехать посмотреть?',
          answer:'В часы работы центра 12:00-20:00 Вы можете записаться на экскурсию по телефону 89049419696, а пока можете ознакомиться с нашей фото-галереей.(добавить фото центра, прилагаю к письму)'
        },
      ],
      rules :[
        {
