let dataObject = {
    ...
    games : [
        ...
        {
          name: `Экшн-игра: Among Us (прятки в лабиринте "Среди нас")` ,
          id: 'among_us',
        ...
        }, 
        {
          ...
          short:'«Кидалки» — это необычно и весело! Ведь вся стена – как огромный живой планшет.',
          ...
          prices:
          'Стоимость за одного игрока:<br><b>300 руб. за 30 минут</b> - в будние дни.<br><b>600 руб.</b> - в выходные, праздники.<br>В стоимость входит: 60 минут аренды, кулер с водой,<br>стаканчики, чай, сахар, микроволновка.',
          booking:
      ...
      locations: [
        
        {
            ...
            coordinates1:{x:55.2033,y:61.3270,text:"Вход"}
        },
      ], 
      rules :[
        {
