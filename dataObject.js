    ...
    games : [
      ...
      questions : [
        ...
        },
        {
          ...
          answer:'С ценами на отдельные виды игр можно ознакомиться в разделе <a href="/book"><button class="btnBlue1">Забронировать</button></a><br/>Пакетные предложения представлены в разделе <a href="/birthday"><button class="btnBlue1">День рождения</button></a><br/>С полным прайсом на все виды услуг можно ознакомиться <a href="/certificate#price"><button class="btnBlue1">Здесь</button></a>'
        },
        {
