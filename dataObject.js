let dataObject = {
    ...
    games : [
        ...
        },
        {
          ...
          prices:
            'Стоимость игры для команды от 2 до 4 человек – от <b>2500</b> до <b>3000 рублей</b>.<br> Доплата за дополнительного игрока – <b>500 рублей</b>',
          booking:
        ...
        },
        {
          ...
          prices:
            'Стоимость за одного игрока:<br><b>550 руб.</b> - в будние дни.<br><b>650 руб.</b> - в выходные, праздники.<br>Независимо от количества игроков минимальная общая стоимость игры: 2600 руб. - в будние дни / 3200 руб. - в выходные, праздники.',
          booking:
            'Игра длится 60 минут',
          gameLength:60,
          locs: [0],
        ...
        },
        {
          ...
          prices:
          'Стоимость за одного игрока:<br><b>550 руб.</b> - в будние дни.<br><b>650 руб.</b> - в выходные, праздники.<br>',
          booking:
            'Игра длится 60 минут',
          gameLength:60,  
          locs: [0],
        ...
        }, 
        {
          ...
          prices:
          'Стоимость за одного игрока:<br><b>330 руб. за 30 минут</b><br>В стоимость входит: 30 минут аренды, кулер с водой,<br>стаканчики, чай, сахар, микроволновка.',
          booking:
        ...
        {
          name: `Квест "Спиритический сеанс"` ,
          nickname:"Спир. Сеанс",
          id: 'spirit',
          bgImage: '/images/spirit.jpg',
          img:'/icons/ghost.svg',
          short:'В доме происходят странные и необъяснимые вещи. Ваша задача в течение часа выяснить, что происходит',
          toWhom:' возрастное ограничение 15+',
          price:2500,
          description:`Легенда: Вы- команда исследователей, изучающих паранормальные явления. Однажды вам поступает звонок от женщины, купившей старинный особняк. В этом доме происходят странные и необъяснимые вещи. Ваша задача в течение часа выяснить, что происходит и постараться помочь.`,
          prices:
          'Стоимость игры для команды от 2 до 4 человек – от <b>2500</b> до <b>3000 рублей</b>.',
          booking:
            'Игра длится 60 минут',
          gameLength:60,
          locs: [0],
      ...
      locations: [
        
        {
            ...
            images:[{link:'/images/room1.jpg',title:'picture1 Hall'},{link:'/images/room2.jpg',title:'front desk'},{link:'/images/room3.jpg',title:'waiting area'},{link:'/images/arrowsign.jpg',title:'Указатели'}]
        },
      ],
      questions : [
        {
          question: 'Это безопасно?',
          answer:'<img src="/images/rulespereulok.jpg" style=" width:300px; margin:auto;" data-pic="callPictureView("\/images\/rulespereulok.jpg","Правила нашего центра")"/><p>Все игроки нашего развлекательного центра перед игрой проходят подробный инструктаж по технике безопасности, правилам игры. В тёмных лабиринтах выдаём специальное игровое оборудование (шлемы, светящиеся браслеты). При условии соблюдения игроками всех правил поведения в локации, игра для них безопасна, крайне интересна и увлекательна.</p>',
        },
        {
          question: 'Могут ли играть дети?',
          answer:'У каждой игры есть свои возрастные ограничения, ознакомиться с ними можно в разделе <a href="/book"><button class="btnBlue1">Забронировать</button></a>'
        },
        {
          question: 'В какой одежде приходить?',
          answer:'В квест- вторая чистая обувь, удобная одежда.<br/>В лабиринт- вторая чистая обувь, тёмная одежда, невысокие причёски.'
        },
        {
          question:'Где находится центр?',
          answer:'Мы находимся по адресу: г.Челябинск, ул.Молодогвардейцев 7 (здание бывшей ткацкой фабрики), Спортивный комплекс Арена (входная группа смотрит на проезжую часть).<br/>На третьем этаже за стойкой Вас встретит администратор, у которого можно уточнить дальнейшее направление движения. Следуйте по коридору, обращая внимание на настенные указатели, далее наши напольные указатели помогут Вам сориентироваться. При соблюдении всех вышеуказанных пунктов Вы с лёгкостью попадёте в наш уютный "Таинственный переулок".(добавить фото навигации, прилагаю к письму).'
        },
        {
          question:'Сколько это стоит?',
          answer:'С ценами на отдельные виды игр можно ознакомиться в разделе: <br/><a href="/book"><button class="btnBlue1">Забронировать</button></a><br/>Пакетные предложения представлены в разделе:<br/><a href="/birthday"><button class="btnBlue1">День рождения</button></a><br/>С полным прайсом на все виды услуг можно ознакомиться: <br/><a href="/certificate#price"><button class="btnBlue1">Здесь</button></a>'
        },
        {
          question:'С нами будут играть другие команды?',
          answer:'На время, которое Вы забронируете, игровая локация будет в распоряжении Вашей команды. Других команд в локации не будет.'
        },
        {
          question:'Сколько игроков может быть в команде?',
          answer:'Квест 2-6 человек<br/>Лабиринт 4-30 человек'
        },
        {
          question:'Есть ли скидки?',
          answer:'-10% скидка имениннику, действует 10 дней ДО и ПОСЛЕ события<br/>-20% скидка для команды из 2-х человек<br/>- максимальная скидка заложена в пакетных предложениях<br/>- скидку можно получить, участвую в акциях и розыгрышах в группе <a href="https://vk.com/chexit"><button class="btnBlue1">ВК</button></a><br/>Акции и скидки не суммируются.'
        },
        {
          question:'Можно приехать посмотреть?',
          answer:'В часы работы центра 10:00-22:00 Вы можете записаться на экскурсию по телефону 89049419696, а пока можете ознакомиться с нашей фото-галереей.(добавить фото центра, прилагаю к письму)'
        },
      ],
      rules :[
        {
