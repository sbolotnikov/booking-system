...
function about() {
  ...
  return (
    <div className="max-w-[1170px] font-['SourceSansPro'] m-auto">
      ...
      <h3 className="text-center p-2 text-gray-400 ">
      Участники игры делятся на две команды: <span className="font-extrabold">Призраки</span> и <span className="font-extrabold">Горожане</span>. В течение 60 минут горожане должны надежно спрятаться, а призраки должны поймать всех горожан.
      </h3>
      <div className="flex flex-col phone:flex-row">
        <button className="m-3 phone:mr-0 phone:rounded-l-md p-2 text-gray-400 bg-gray-900 focus:text-white focus:bg-gray-800  " onClick={e=>{setSwitchArray(listArraySteps)}}>Ход игры</button>
        <button className="m-3 phone:ml-0 phone:rounded-r-md p-2 text-gray-400 bg-gray-900  focus:text-white  focus:bg-gray-800  " onClick={e=>{setSwitchArray(listArrayVictory)}}>Условия победы</button>
        </div>
